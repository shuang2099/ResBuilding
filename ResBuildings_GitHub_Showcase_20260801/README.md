...
<p align="center">
  <img src="assets/cover.jpg" alt="ResBuildings cover" width="100%">
</p>
...
<p align="center">
  <a href="#总体框架--architecture">总体框架 / Architecture</a> · <a href="#中文介绍">中文</a> · <a href="#english">English</a> · <a href="#演示视频--demo-videos">演示视频 / Demo Videos</a>
</p>

> 本仓库是功能与研究创新展示，不包含源代码、工程数据、模型文件、密钥或服务器配置。  
> This repository is a functionality and research-innovation showcase. Source code, engineering data, model files, credentials, and server configuration are not included.

## 演示视频 / Demo Videos

| 中文演示 / Chinese Demo | English Demo |
|---|---|
| [观看或下载中文演示](videos/ResBuildings_Chinese_Demo_GitHub.mp4) | [Watch or download the English demo](videos/ResBuildings_English_Demo_GitHub.mp4) |

## 总体框架 / Architecture

![ResCity Agent Framework](assets/rescity-agent-framework.jpg)
...
|---|---|
| ![任务规划](assets/task-planning.jpg) | ![二维结果](assets/results-2d.jpg) |

| 城市建筑群三维展示 | 用户资源扩展 |
|---|---|
| ![三维建筑群](assets/city-3d.jpg) | ![资源扩展](assets/resource-extension.jpg) |

| 智能模式 |
|---|
| ![智能模式](assets/intelligent-mode.jpg) |
